...
const getConsultationPost = (id: number) => get(
...
const postInviteUserToConsultation = (id: string, userId: string) => post(`api/consultations/${id}/invite/${userId}`, null, Config.withToken());
const postChangeProfilePicture = (data: any) => post('api/profile/picture', data, Config.withToken());
const postUpdateProfile = (data: any) => post('api/profile', data, Config.withToken());

// Put
const putCloseConsulation = (id: string) => put(`api/consultations/${id}/close`, null, Config.withToken());
